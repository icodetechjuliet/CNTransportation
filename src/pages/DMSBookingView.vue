            ...
            <q-tab-panel name="general">
              <div class="row q-col-gutter-sm">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                  ...
                  <q-select v-model="form.Carrier" :options="['Own', 'Truck', 'Air']" dense outlined bg-color="blue-1" :readonly="dialogMode === 'view'" />
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
...
<script>
import { apiGetBookingById, apiSaveBooking, MOCK_DATA } from "./DMSBooking.vue";
