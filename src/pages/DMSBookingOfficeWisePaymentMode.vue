            ...
            <div class="total-stat-tile total-stat-tile--inline">
              ...
              <div class="total-stat-text">
                <span class="total-stat-count">
                  {{ filteredWisePaymentModes.length }}
                </span>
          ...
          >
            ...
            <template v-slot:item="props">
              <div class="mobile-job-card">
                <div
                  class="mjc-header"
                  @click="toggleMobileCard(props.row.WisePaymentModeId)"
                >
                ...
                <transition name="mobile-expand">
                  <div
                    v-if="
                      expandedMobileCards.includes(props.row.WisePaymentModeId)
                    "
                    class="mjc-details"
                  >
                    ...
                    <div class="mjc-details-grid">
                      <div class="mjc-detail-row">
                        <span class="mjc-detail-label">Payment Mode</span>
...
// Booking Office Wise Payment Mode data/mock-"backend" now lives in its
// own module, src/data/bookingOfficeData.js (localStorage-backed, so
...
import {
  apiGetWisePaymentModes,
  apiSaveWisePaymentMode,
  apiDeleteWisePaymentMode,
...
export default {
  ...
  entryReload: "loadWisePaymentModes",
  ...
  methods: {
    ...
    async loadWisePaymentModes() {
      this.filteredWisePaymentModes = await apiGetWisePaymentModes(
        this.searchText
      );
    },
    ...
    openAddWisePaymentMode() {
      this.openEntryPage(
        "/DMSBookingOfficeWisePaymentModeView?mode=add",
        "New Wise Payment Mode"
      );
    },
    ...
    confirmDeleteWisePaymentMode(row) {
      this.$q
        ...
        .onOk(async () => {
          ...
          this.$q.notify({
            message: "Wise Payment Mode deleted",
            color: "negative",
            position: "top",
          });
          this.loadWisePaymentModes();
