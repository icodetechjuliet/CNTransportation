          ...
          >
            ...
            <template v-slot:item="props">
              <div class="mobile-job-card">
                <div
                  class="mjc-header"
                  @click="toggleMobileCard(props.row.DebitCollectionId)"
                >
                ...
                <transition name="mobile-expand">
                  <div
                    v-if="
                      expandedMobileCards.includes(props.row.DebitCollectionId)
                    "
                    class="mjc-details"
                  >
...
// Booking Office Wise Debit Collection data/mock-"backend" now lives in
...
import {
  apiGetDebitVouchers as apiGetVouchers,
  apiSaveDebitVoucher as apiSaveVoucher,
  apiDeleteDebitVoucher as apiDeleteVoucher,
  apiGetDebitVoucherById as apiGetVoucherById,
  MOCK_DATA_WISE_DEBIT_COLLECTION as MOCK_DATA,
...
export default {
  ...
  methods: {
    ...
    openAddVoucher() {
      this.openEntryPage(
        "/DMSBookingOfficeWiseDebitCollectionView?mode=add",
        "New Debit Collection"
      );
    },
    ...
    async saveVoucher() {
      ...
      if (res.success) {
        this.$q.notify({
          message: "Debit Collection saved!",
          color: "positive",
          position: "top",
        });
    ...
    confirmDeleteVoucher(row) {
      this.$q
        ...
        .onOk(async () => {
          ...
          this.$q.notify({
            message: "Debit Collection deleted",
            color: "negative",
            position: "top",
          });
          this.loadVouchers();
