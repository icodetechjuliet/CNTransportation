...
const SEED_TRIPS = [
  {
    ...
    Posted: true,
    // Rate/FreightAmount/HamaliAmount/OtherAmount/ExpenseAmount/
    // NetPayableAmount/PaidAmount/BalanceAmount mirror the transporter
    // settlement columns TRP_Trip_TripRegisterTransporterWise.rdlc prints
    // per trip (Weight/Rate/Freight/Hamali/Other Amt./Expense Amt./Net
    // Payable Amt./Advance Amt./Paid Amt./Balance Amt.) — see
    // DMSTripRegisterTransporterWise.vue.
    Rate: 7.0,
    FreightAmount: 10150,
    HamaliAmount: 600,
    OtherAmount: 250,
    ExpenseAmount: 450,
    NetPayableAmount: 10550,
    PaidAmount: 9000,
    BalanceAmount: 1550,
    OtherDetails: { InsuranceNo: "", EwayBillRefNo: "", SpecialInstructions: "" },
    // ItemName/Quantity/Weight/FreightAmount/TaxAmount/NetAmount/ItemBillNo
    // mirror the columns TRP_Trip_LoadingSheet_Truck_WithHeader.rdlc /
    // _WithoutHeader.rdlc actually print per L.R. (Item, Qty., Weight,
    // Freight [=AssessableAmount], S.T. [=TotalTaxAmount], Total Amt.
    // [=NetAmount]) — buildTripSheetHtml in DMSTrip.vue renders these.
    Bookings: [
      { BookingTranId: 1, Load: true, Status: "Delivered", BookingNo: "RKG21032654", Date: "30-03-2026", Carrier: "own", LoadCarrier: "own", Payment: "Paid", ToCity: "Vasai", Consignee: "Biba Apparels Pvt Ltd", FromCity: "Rajkot-G", Consignor: "KUDOS HARDWARE SOL", ItemName: "Hardware Fittings", ItemBillNo: "KHS-2601", Quantity: 20, Weight: 450.0, FreightAmount: 3200.0, TaxAmount: 576.0, NetAmount: 3776.0 },
      { BookingTranId: 2, Load: true, Status: "Delivered", BookingNo: "MTD21030687", Date: "30-03-2026", Carrier: "own", LoadCarrier: "Truck", Payment: "TBBR", ToCity: "Vasai", Consignee: "Liberty Valves Pvt Ltd", FromCity: "Metoda", Consignor: "Mechseal Valve Pvt Ltd", ItemName: "Industrial Valves", ItemBillNo: "MVP-1187", Quantity: 15, Weight: 620.0, FreightAmount: 4100.0, TaxAmount: 738.0, NetAmount: 4838.0 },
      { BookingTranId: 3, Load: true, Status: "Delivered", BookingNo: "RKS21031011", Date: "30-03-2026", Carrier: "own", LoadCarrier: "Truck", Payment: "TBBS", ToCity: "Vasai", Consignee: "GAJANAN PRECISION INDUSTRI...", FromCity: "Rajkot-5", Consignor: "Micro Melt Pvt Ltd", ItemName: "Precision Castings", ItemBillNo: "MMP-0942", Quantity: 11, Weight: 380.0, FreightAmount: 2850.0, TaxAmount: 513.0, NetAmount: 3363.0 },
    ],
  },
  {
    TripId: 2,
